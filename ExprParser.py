...
class ExprParser ( Parser ):
    ...
    class ProgContext(ParserRuleContext):
        ...
        def accept(self, visitor:ParseTreeVisitor):
            if isinstance( visitor, ExprVisitor ):
    ...
    def prog(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << ExprParser.T__1) | (1 << ExprParser.T__2) | (1 << ExprParser.CLEAR) | (1 << ExprParser.ID) | (1 << ExprParser.INT) | (1 << ExprParser.END))) != 0)):
                    break
    ...
    class ClearContext(StatContext):
        ...
        def CLEAR(self):
            return self.getToken(ExprParser.CLEAR, 0)
        def END(self):
            return self.getToken(ExprParser.END, 0)
    ...
    def stat(self):
        ...
        try:
            ...
            if la_ == 1:
                ...
                localctx = ExprParser.ClearContext(self, localctx)
                self.enterOuterAlt(localctx, 3)
                self.state = 23
                self.match(ExprParser.CLEAR)
                self.state = 24
                self.match(ExprParser.END)
                pass
                ...
                localctx = ExprParser.DefineContext(self, localctx)
    ...
    def params(self):
        ...
        try:
            ...
            if la_ == 1:
                localctx = ExprParser.MultparamContext(self, localctx)
                self.enterOuterAlt(localctx, 1)
                self.state = 62
                self.match(ExprParser.ID)
                self.state = 63
                ...
                localctx = ExprParser.SingleparamContext(self, localctx)
                self.enterOuterAlt(localctx, 2)
                self.state = 65
                self.match(ExprParser.ID)
                pass
    ...
    class MultargContext(ArgsContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a ExprParser.ArgsContext)
            super().__init__(parser)
            self.copyFrom(ctx)
    ...
    def args(self):
        ...
        try:
            ...
            if la_ == 1:
                localctx = ExprParser.MultargContext(self, localctx)
                self.enterOuterAlt(localctx, 1)
                self.state = 68
                self.expr(0)
                self.state = 69
                ...
                localctx = ExprParser.SingleargContext(self, localctx)
                self.enterOuterAlt(localctx, 2)
                self.state = 72
                self.expr(0)
                pass
